    ...
    <div class="tab rb" style="width:87%;">
        <div style="background:#FFF; width:100%; color:#333; text-align:left;">
            ...
            <font style="font-size:20px"> <img src="./img/<?= $row['poster'] ?>" width="200px" height="250px" style="margin:10px; float:left">
                ...
                <p style="margin:3px">影片分級 ： <img src="./icon/03C0<?= $row['level'] ?>.png" style="display:inline-block;"><?= $sess[$row['level']] ?>
                </p>
