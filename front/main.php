                ...
                <div class="movie">
                    <div style="font-size:12px;">
                        ...
                        <div>
                            ...
                            <div>分級：<img src="./icon/03C0<?= $m['level'] ?>.png" style="width:15px;"><?= $lev[$m['level']] ?></div>
                            <div>上映日期：<?= $m['ondate'] ?></div>
                        </div>
                    </div>
                    <div class="ct"><button onclick="location.href='?do=intro&id=<?= $m['id'] ?>'">劇情簡介</button> <button onclick="location.href='?do=order&id=<?= $m['id'] ?>'">線上訂票</button></div>
                </div>
            <?php
            }
            ?>
