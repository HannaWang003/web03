...
{
    protected $table;
    protected $dsn = "mysql:host=localhost;charset=utf8;dbname=db3";
    protected $pdo;
    ...
    function page($now, $div, $where = "", $other = "")
    {
        $ary['total'] = $this->count($where, $other);
        $ary['pages'] = ceil($ary['total'] / $div);
        $ary['start'] = ($now - 1) * $div;
        return $ary;
    }
}
