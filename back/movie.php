...
?>
    ...
    <div class="movie">
        ...
        <div>
            ...
            <div>
                <button onclick="sh(<?= $row['id'] ?>)"><?= ($row['sh'] == 1) ? "<span>顯示</span>/<span>隱藏</span>" : "<span>隱藏</span>/<span>顯示</span>" ?></button>
                <button class="sw" data-id="<?= $row['id'] ?>" data-sw="<?= ($idx > 0) ? $rows[$idx - 1]['id'] : $row['id'] ?>">往上</button>
                <button class="sw" data-id="<?= $row['id'] ?>" data-sw="<?= ($idx < $total - 1) ? $rows[$idx + 1]['id'] : $row['id'] ?>">往下</button>
